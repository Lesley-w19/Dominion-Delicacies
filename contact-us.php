            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>GET IN TOUCH</h2>
                        <p>Contact us for any clarification or information needed. Give us your feedback, compalints or remarks. We would love to hear from you.</p>
                ...
                <p>
                We are a company that provides and manufactures naturally nutritious and tasty  flavours of products.
                </p>
                        <ul>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i>Address: <br> P.o Box 55489-0200 <br /> Nairobi,Kenya. </p>
                            </li>
                            <li>
                            <p>
                      ...
                      <a href="mailto:DominionDelicacies98@gmail.com"
                        >DominionDelicacies98@gmail.com</a></p>
                            </li>
                        </ul>
                    </div>
                </div>

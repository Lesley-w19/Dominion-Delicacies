        ...
        <div class="container">
            <div class="row new-account-login">
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <h5><array href="login-user.php" role="button" style="color:#b0b435" >Click here to Login</array></h5>
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <h5><a  href="signup-user.php" role="button"  style="color:#b0b435" >Click here to Register</a></h5>

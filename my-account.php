...
$get_user_data = mysqli_query($con, "SELECT * FROM `useraccounts` WHERE user_email = '$email'");
...
?>
    ...
    <!-- End All Title Box -->
    <button style="border-bottom: 2px solid #000; width:100%; text-align:end; " type="button" class="btn btn-light"><a href="logout-user.php" ><h2 class="logout"  >Logout</h2></a></button>
    <!-- Start My Account  -->
